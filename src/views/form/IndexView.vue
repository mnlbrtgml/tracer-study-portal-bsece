<template>
  <section>
    <div class="container mx-auto p-2 space-y-4 md:p-4 lg:p-8">
      <form
      ...
      >
        ...
        <div class="grid gap-2.5">
          <div class="grid gap-1">
            <label for="form[1][1]">Present occupation</label>
          ...
          <div class="grid gap-1">
            <label for="form[1][1]">Employment status</label>
            <select v-model="form[2][1]" id="form[2][1]" required>
              <option value="null" disabled selected></option>
          ...
          <div>
            <label for="form[1][6]">Salary level</label>
            <InputText v-model.trim="form[1][6]" id="form[1][6]" />
          </div>

          <div>
            <label for="form[1][6]">Place of work</label>
            <InputText v-model.trim="form[1][6]" id="form[1][6]" required />
          </div>

          <div>
            <label for="form[1][6]">Name of company</label>
            <InputText v-model.trim="form[1][6]" id="form[1][6]" required />
          </div>

          <div>
            <label for="form[1][2]">Reasons for staying on the job</label>
            <InputLongText v-model.trim="form[1][2]" id="form[1][2]" />
          </div>

          <div>
            <label for="form[1][6]">Years of first employment after graduation</label>
            <InputNumber v-model.trim="form[1][6]" id="form[1][6]" required />
          </div>

          <div>
            <label for="form[1][2]">Reasons for changing the job</label>
            <InputLongText v-model.trim="form[1][2]" id="form[1][2]" />
          </div>

          <div>
            <label for="form[1][6]">Medium or channel used for job search</label>
            <InputText v-model.trim="form[1][6]" id="form[1][6]" required />
          </div>
          ...
          <div>
            <label for="form[1][6]">Certifications/Training/Skill needs of employer</label>
            <InputText v-model.trim="form[1][6]" id="form[1][6]" />
          </div>
        </div>
      </div>
